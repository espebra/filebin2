...
<html lang="en">
    ...
    <body class="container-xl">
        ...
        <p>It is a good idea to encrypt files before uploading them. Files that are not encrypted prior to being uploaded are readable by the service owner. The filenames of any uploaded files are readable by the service owner.</p>

        <p>All transactions, including information such as the source IP address of clients uploading and downloading files, are logged for purposes such as analytics and abuse handling and may be shared with third parties in these contexts.</p>
