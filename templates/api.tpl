...
<html lang="en">
    ...
    <body class="container-xl">
        ...
        <p>This API documentation page is generated from the <a href="/api.json">Swagger 2.0 specification</a> and aims to make it easy to create tools to upload, list, download and delete files from Filebin.</p>
