...
<html lang="en">
    ...
    <body class="container-xl">
        ...
        <p>This documentation is generated by <a href="/api.json">Swagger 2.0</a> and aims to make it easy to create tools to upload, list, download and delete files from Filebin.</p>
