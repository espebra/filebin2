	...
	tcs := []TestCase{
		{
			...
			Method:          "GET",
			Bin:             "filebin-test-text.txt",
			DownloadContent: "/filebin-test-text/a\n/filebin-test-text/b\n",
			StatusCode:      200,
		},
	}
	runTests(tcs, t)
